...
part of 'DeviceActionService.dart';
...
class _DeviceActionService implements DeviceActionService {
  ...
  @override
  Future<Device> updateDeviceQuantity(Map<String, dynamic> payload) async {
